...
const carouselItems = [
  { id: 1, content: <div style={{ height: '300px', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '32px', fontWeight: 'bold' }}>Slide 1</div> },
  { id: 2, content: <div style={{ height: '300px', background: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '32px', fontWeight: 'bold' }}>Slide 2</div> },
  { id: 3, content: <div style={{ height: '300px', background: 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '32px', fontWeight: 'bold' }}>Slide 3</div> },
];
  ...
  return (
    <div style={{ paddingTop: '60px' }}>
      ...
      <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <section style={{ marginBottom: '40px' }}>
          <h2 style={{ marginBottom: '16px' }}>Carousel</h2>
          <Carousel
            items={carouselItems}
            autoPlay
            showDots
        ...
        <section style={{ marginBottom: '40px' }}>
          <h2 style={{ marginBottom: '16px' }}>Pagination</h2>
          <Pagination
            currentPage={currentPage}
            totalPages={20}
            onPageChange={setCurrentPage}
          />
          <p style={{ marginTop: '8px', color: 'var(--gallui-text-secondary)' }}>
            Page: {currentPage}
          </p>
        </section>

        <section style={{ marginBottom: '40px' }}>
          <h2 style={{ marginBottom: '16px' }}>Navbar</h2>
          <div style={{ marginBottom: '16px' }}>
            <p style={{ marginBottom: '8px', fontWeight: 'bold' }}>Default</p>
            <Navbar
              logo={<span>Logo</span>}
          ...
          <div style={{ marginBottom: '16px' }}>
            <p style={{ marginBottom: '8px', fontWeight: 'bold' }}>Transparent</p>
            <div style={{ background: '#f0f0f0', padding: '8px', borderRadius: '8px' }}>
              <Navbar
                logo={<span>Logo</span>}
                items={navItems.slice(0, 3)}
                variant="transparent"
          ...
          <div>
            <p style={{ marginBottom: '8px', fontWeight: 'bold' }}>Dark</p>
            <Navbar
              logo={<span>Logo</span>}
              items={navItems.slice(0, 3)}
              variant="dark"
